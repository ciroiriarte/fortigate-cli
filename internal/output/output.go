...
// Tabular is an ordered set of columns and rows. Cells are pre-stringified for
...
// project selects and reorders columns. Unknown column names render as an empty
// column rather than failing the whole render.
